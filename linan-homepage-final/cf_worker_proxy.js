// Cloudflare Workers - 智谱 GLM API 代理
// 部署步骤：
// 1. 访问 https://workers.cloudflare.com 注册账号
// 2. 创建新 Worker，把下面代码粘贴进去
// 3. 把 API_KEY 换成你的真实 Key
// 4. 保存并获取 Worker URL（如 https://linan-bot.yourname.workers.dev）
// 5. 把该 URL 填入前端代码的 PROXY_URL 中
...
`;
      ...
      return new Response(
        JSON.stringify({
          reply: data.choices?.[0]?.message?.content || '抱歉，我暂时没想好怎么回答。',
        }),
        {
          status: 200,
          headers: {
